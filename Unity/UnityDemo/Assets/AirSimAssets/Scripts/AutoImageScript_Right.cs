...
public class AutoImageScript_Right : MonoBehaviour
{
    ...
    void CamCapture()
    {
        ...
        File.WriteAllBytes(Application.dataPath + "/ImageSequence/" + "Right_" + FileCounter + "_P_" + transform.position.x.ToString("0.00") + 
