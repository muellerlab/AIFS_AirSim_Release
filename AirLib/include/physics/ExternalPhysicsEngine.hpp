...
public:
    ExternalPhysicsEngine(bool enable_ground_lock = true, Vector3r wind = Vector3r::Zero())
    ...
    virtual void update() override
    {
        ...
        return; // do not update kinematics, move drone just with setVehiclePose
        for (PhysicsBody* body_ptr : *this) {
...
private:
    ...
    void updatePhysics(PhysicsBody& body)
    {
        ...
        getNextKinematicsNoCollision(dt, body, current, next, next_wrench, wind_); //TODO: set this through code
